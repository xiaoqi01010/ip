...
public class TestSophiaList {
    /**
     * test delete function in sophia
     * @throws SophiaException if the command entered does not fit the format
     * @throws IOException if file cannot be found or cannot be created
     */
    @Test
